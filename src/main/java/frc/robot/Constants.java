...
public final class Constants {
  ...
  public static final double RPM_TO_VOLTAGE = 1/463;
  ...
  public static final class ControlConstants {
    ...
    public static final double CLIMBER_RUNNER_INITIAL_RUN_SPEED = .2;
    public static final double CLIMBER_RUNNER_INITIAL_REVERSE_SPEED = .4;
